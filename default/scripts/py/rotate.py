...
touchscreen_names = ['touchscreen', 'wacom', 'Atmel']
touchscreens = 'Atmel Atmel maXTouch Digitizer' #[i for i in devices if any(j in i.lower() for j in touchscreen_names)]

disable_touchpads = True

touchpad_names = ['touchpad', 'trackpoint']
touchpads = 'ETPS/2 Elantech Touchpad' #[i for i in pytohdevices if any(j in i.lower() for j in touchpad_names)]
